...
test('I can search Google', async () => {
    ...
    await searchBar.sendKeys('Darth Yall\n')
    ...
    await searchBar.sendKeys('Doom Patrol Memes\n')

    // await searchBar.sleep(2000) got error saying searchBar.sleep isnt a function
})